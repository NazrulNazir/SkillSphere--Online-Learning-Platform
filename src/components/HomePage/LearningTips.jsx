    ...
    return (
        <div className='px-5 sm:px-10 lg:px-15 mb-20'>
            <div className='bg-base-300 py-10 px-8 rounded-2xl'>
                <h1 className='flex items-center text-4xl font-bold text-neutral-800 gap-3'><FcGraduationCap />Learning Tips</h1>
                <p className='text-xl text-neutral-500 font-semibold mt-4'>Improve your learning skills and achieve your goals faster.
                </p>
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-7 mt-8'>
                <div className = 'flex gap-4 justify-center items-center'>
                    ...
                    <div>
                        ...
                        <p className='text-lg text-neutral-600 mt-3'>Take notes, ask questions and engage actievely with the content.</p>
                    </div>
                </div>
                ...
                <div className = 'flex gap-4 justify-center items-center'>
                    ...
                    <div>
                        ...
                        <p className='text-lg text-neutral-600 mt-3'>Create a study schedule and stick to it. Consistencyis the key.</p>
                    </div>
                </div>
                ...
                <div className = 'flex gap-4 justify-center items-center'>
                    ...
                    <div>
                        ...
                        <p className='text-lg text-neutral-600 mt-3'>Set small and achievable goals tostay motivated every day.</p>
                    </div>
                </div>
                <div className = 'flex gap-4 justify-center items-center'>
                    ...
                    <div>
                        ...
                        <p className='text-lg text-neutral-600 mt-3'>Practice what you learn regularly to build strong foundations.</p>
                    </div>
                </div>
            </div>
            </div>
